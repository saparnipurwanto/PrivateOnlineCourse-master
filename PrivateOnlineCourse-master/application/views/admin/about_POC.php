...
<head>
	...
	<title>Tentang Developer - POC</title>
	<!-- General CSS Files -->
		...
		<div class="main-wrapper">
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="dropdown-title">Admin - POC</div>
					...
					<ul class="sidebar-menu">
						...
						<li class="nav-item dropdown active">
							...
							<ul class="dropdown-menu">
								...
								<li><a class="nav-link" href="<?= base_url('admin/about_POC') ?>">Tentang
										POC</a>
								</li>
							</ul>
						</li>
			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang Web POC </h1>
					</div>
					<div class="">
					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Tentang POC</h2>
								<hr>
								<p class="card-text">Web Edukasi Open Source yang dibuat oleh Kelompok Kami. <br> POC adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. <br> POC dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja. </p>
							</div>
						</div>
					</div>
				</section>
			...
			<footer class="main-footer">
				<div class="text-center">
					Copyright &copy; 2022 <div class="bullet"></div><a href="https://github.com/chandraspt">Private Online Course</a>
				</div>
			</footer>
			<!-- End Footer -->
