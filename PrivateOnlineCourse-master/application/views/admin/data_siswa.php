        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Siswa POC</h2>
                            <hr>
                            <p class="card-text"> Data siswa disini menunjukkan tabel dimana siswa yang sudah terdaftar. </p>
