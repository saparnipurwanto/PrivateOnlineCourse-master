				...
				<section class="section">
					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Kelompok Kami</h2>
								<hr>
								<p class="card-text">Kami adalah Developer pemula yang mencari wawasan dan mencari contoh website yang akan kami buat  </p>
							</div>
						</div>
					</div>
					<br>
