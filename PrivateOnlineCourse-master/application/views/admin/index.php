...
<head>
    ...
    <title>Admin Dashboard - POC</title>
    <!-- General CSS Files -->
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= base_url('admin') ?>">POC <sup>3</sup></a>
                    </div>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Jika admin ingin menambahkan materi ini adalah bagian untuk menambahkan materi</p>
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">Jika admin ingin melihat data siswa ini adalah bagian untuk melihat data siswa</p>
                                <div class="mt-4">
