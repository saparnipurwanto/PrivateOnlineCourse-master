...
@About-POC :
Web Edukasi Open Source yang dibuat oleh My team.
POC adalah Web edukasi yang dilengkapi video, materi dan sistem ujian
yang tersedia secara gratis. POC dibuat ditujukan agar para siswa dan
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang POC</a></li>
                        <li><a href="<?= base_url('welcome/pelajaran') ?>">Pelajaran POC</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak POC</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li>Kami adalah Developer pemula yang mencari wawasan dan mencari contoh website yang akan kami buat.</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang POC</h4>
                <p>
                    Web Edukasi Open Source yang dibuat oleh Kelompok Kami. POC adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. POC dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> POC is made with <span class="text-danger"> &#10084;</span> by <a href="https://github.com/chandraspt">Private Online Course</a> with my team
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            <div class="col-lg-4 col-md-4 footer-social">
                <a href="https://www.facebook.com/Cristiano/"><i class="fa fa-facebook"></i></a>
                <a href="https://twitter.com/elonmusk"><i class="fa fa-twitter"></i></a>
                <a href="https://github.com/chandraspt"><i class="fa fa-github"></i></a>
                <a href="https://www.instagram.com/antoir_/?next=%2F&hl=id"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
</footer>
