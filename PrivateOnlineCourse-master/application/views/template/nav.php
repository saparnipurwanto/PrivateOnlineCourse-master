...
<head>
    ...
    <meta content="POC dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja." name="Description" />
    <meta content="POC, E-learning, Open Source, Syauqi Zaidan Khairan Khalaf, github, programmer indonesia" name="keywords" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/favicon.png" type="image/png">
    <title>POC - Belajar Dimana Saja & Kapan Saja !</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="container">
                <div class="float-left">
                    <ul class="list header_social">
                        <li><a href="https://www.facebook.com/Cristiano/"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://twitter.com/elonmusk"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="https://github.com/chandraspt"><i class="fa fa-github"></i></a></li>
                        <li><a href="https://www.instagram.com/antoir_/?next=%2F&hl=id"><i class="fa fa-instagram"></i></a></li>
                    </ul>
                </div>
                <div class="float-right">
                    <a class="dn_btn" href="mailto:apps.POC@gmail.com">apps.POC@gmail.com</a>
                </div>
            </div>
        </div>
